...
import { manoj, react, node, express, mongo, sass, redux, git, github } from '../includes/assets'
		...
		<div className="about">
			<div className="about__wrapper">
				<div className="about__left">
					<span className="about__left__logo">Story Flick</span>
					<div>
						<img
							src={manoj}
							...
							crossOrigin="true"
						/>
						<span className="about__left__name">Manoj Kumar</span>
